...
| 🟩 Imperative programming      | 🟩 new                | ⬜ Mutable state     | 🟩 Strategy              |
| 🟩 Structured programming      | 🟩 Static method      | ⬜ Immutable state   | 🟩 Factory               |
| 🟩 Non-structured programming  | 🟩 Method             | 🟩 Enum              | 🟩 Abstract factory      |
